...
export default function MovieCard ({title,poster_path, _id} : CardProps) {
  return (
      <Link to={`/movie/${_id}`} className="w-52 p-2 flex flex-col  text-white transition duration-500 ease-in-out transform hover:scale-105">
